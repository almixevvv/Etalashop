...
<head>
    ...
    <?php if (isset($productName)) { ?>
        <title><?php echo $productName; ?> | ETALAshop Official Site</title>
    <?php } else { ?>
        <title><?php echo $sectionName; ?> | ETALAshop Official Site</title>
    <?php } ?>

    <link rel="shortcut icon" href="<?php echo base_url('assets/images/logo_big.png'); ?>">
    ...
    <script type="text/javascript" src="https://app.sandbox.midtrans.com/snap/snap.js" data-client-key="<?php echo SNAP_CLIENT_KEY; ?>"></script>
</head>
