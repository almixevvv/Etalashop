			...
			<div class="col-12 col-md-5 pl-0 pr-0 pl-md-4">
				<div class="card">
					...
					<div class="row">
						...
						<div class="col-6 col-md-6 col-sm-6 text-right">
							IDR <span class="font-weight-bold pr-4"><?= ($weightPrice == 0 ? '0.00' : number_format($weightPrice, 2, ',', '.')) ?></span>
						</div>
					</div>
					...
					<div class="row pl-3 mt-3 mb-3">
						...
						<div class="col-6" style="text-align: right">
							<button type="submit" class="btn text-cart-button mr-4" id="btnCheckOut" title="Submit Inquiry" style="background-color: #69c2ac; color:#fff; font-size: 1em" <?= ($row == 0 ? 'disabled' : ''); ?>>CHECKOUT&nbsp;<i class="fa fa-angle-right"></i></button>
						</div>
					</div>
