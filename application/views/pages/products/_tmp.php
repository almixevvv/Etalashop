  ...
  <div class="row">
    ...
    <div class="col-1 col-md-1 col-lg-1 col-xl-1 order-0 order-md-1 order-lg-1 order-xl-1 d-none d-md-block d-lg-block d-xl-block">
      ...
      if (($countProduct>=1)) {
        ...
        foreach ($dataproduct->result() as $picture) {

          if (isset($picture->IMAGES1) && strlen($picture->IMAGES1) > 1) { ?>
            <div class="detail-border">
              <center>
                <img data-picture="<?= $picture->IMAGES1; ?>" class="row-images" alt="Product Picture" src="<?= $picture->IMAGES1; ?>" onerror="this.onerror=null;this.src='<?php echo base_url('assets/images/no-image-icon.png'); ?>' " />
              </center>
            </div>
        <?php }
        }
        ...
        <div class="detail-border">
          <center>
            <img data-picture="<?= 'assets/images/uploads/products' . $dataproduct->detail->productDetailVO->picture; ?>" class="row-images" style="max-width: 30px" alt="Product Picture" src="<?= 'assets/images/uploads/products' . $dataproduct->detail->productDetailVO->picture; ?>" onerror="this.onerror=null;this.src='<?php echo base_url('assets/images/no-image-icon.png'); ?>' " />
          </center>
        </div>
        ...
        <?php if (!empty($dataproduct->detail->sdiProductsPicList)) {
          ...
          foreach ($dataproduct->detail->sdiProductsPicList as $picture) {
            ...
            if (isset($picture->picture1) && strlen($picture->picture1) > 1) { ?>
              <div class="detail-border">
                <center>
                  <img data-picture="<?= 'assets/images/uploads/products' . $picture->picture1; ?>" class="row-images" alt="Product Picture" src="<?= 'assets/images/uploads/products' . $picture->picture1; ?>" onerror="this.onerror=null;this.src='<?php echo base_url('assets/images/no-image-icon.png'); ?>' " />
                </center>
              </div>
          <?php }
          }
    ...
    <div class="col-12 col-md-5 col-lg-5 col-xl-5 order-1 order-md-2 order-lg-2 order-xl-3">
      <div class="detail-border">
        <div class="d-flex justify-content-center">
          <img class="detail-main-images" alt="<?= $dataproduct->detail->productDetailVO->title; ?>" src="<?= 'assets/images/uploads/products' . $dataproduct->detail->productDetailVO->picture; ?>" />
